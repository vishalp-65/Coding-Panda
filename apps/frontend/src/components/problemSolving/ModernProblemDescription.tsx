...
const ModernProblemDescription = ({
  ...
  return (
    <div className="h-full flex flex-col bg-gray-100 text-black dark:text-white dark:bg-gray-900">
      {/* Header */}
            ...
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: problem.description
                  ...
                  .replace(
                    /```([\s\S]*?)```/g,
                    '<pre class="bg-gray-800 p-3 rounded-md overflow-x-auto"><code class="text-gray-300">$1</code></pre>'
                  )
                  .replace(/\n/g, '<br>'),
              }}
            />
