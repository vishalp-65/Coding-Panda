# PowerShell script to start Code Execution Service

Write-Host "Starting Code Execution Service..." -ForegroundColor Green
...
& ".venv\Scripts\python.exe" -m uvicorn main:app --host 0.0.0.0 --port 3004 --reload